    ...
    (setq org-capture-templates
	  (quote (
		  ...
		  ("n" "note" entry (file+headline "~/Dropbox/document/org/capture/capture.org" "Notes")
		   "* %?\n%U\n%a\n")
		  ("a" "appointments")
		  ("ar" "repeating appointments" entry (file+headline "~/Dropbox/document/org/appts/appts.org" "Repeating Appointments")
		   "* TODO %?")
		  ("af" "far away appointments" entry (file+headline "~/Dropbox/document/org/appts/appts.org" "Far Away Appointments")
		   "* TODO %?")
		  ("an" "repeating appointments" entry (file+headline "~/Dropbox/document/org/appts/appts.org" "Near Appointments")
		   "* TODO %?")
		  )))
