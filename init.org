...
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package ivy-posframe
    ...
    (setq ivy-posframe-hide-minibuffer t
	  ...
	  ivy-posframe-width (round (* (frame-width) 0.49)))
    (custom-set-faces '(ivy-posframe-border ((t (:inherit default)))) )
    ...
    (push '(counsel-find-file . ivy-posframe-display-at-frame-center) ivy-display-functions-alist)
    (push '(counsel-projectile-find-file . ivy-posframe-display-at-frame-center) ivy-display-functions-alist)
    (push '(flyspell-correct-wrapper . ivy-posframe-display-at-frame-center) ivy-display-functions-alist)
    (push '(counsel-apropos . ivy-posframe-display-at-frame-center) ivy-display-functions-alist)
    (push '(swiper . ivy-posframe-display-at-frame-bottom-left) ivy-display-functions-alist)
    (ivy-posframe-enable))
#+END_SRC
** company related
*** company
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/toggle-lsp-ui-mode ()
	...
	(progn
	  (lsp-ui-mode -1)
	  (message "Lsp ui mode disabled in current buffer"))
      (progn
	(lsp-ui-mode 1)
	(message "Lsp ui mode enabled in current buffer"))))
#+END_SRC
* writing
** academic phrases
#+BEGIN_SRC emacs-lisp
